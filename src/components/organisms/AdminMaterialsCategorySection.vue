      ...
      <div class="admin-materials-category-section__item-left">
        ...
        <div class="admin-materials-category-section__stats">
          <div class="admin-materials-category-section__stat">
            <button type="button" class="admin-materials-category-section__icon-button" aria-label="Настройки">
              <svg
      ...
      <div class="admin-materials-category-section__panel-inner" :inert="!expanded" :aria-hidden="!expanded">
        ...
        >
          <div
            ...
            class="admin-materials-category-section__panel-actions"
            :style="{ '--section-accent': borderColor }"
          >
            <RouterLink
              class="admin-materials-category-section__add-product"
...
.admin-materials-category-section__panel-actions {
  display: flex;
  justify-content: flex-end;
  margin-bottom: var(--sp-20);
}

.admin-materials-category-section__add-product {
